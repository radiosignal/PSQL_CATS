...
--
-- Name: championship_result; Type: TYPE; Schema: public; Owner: robot
--

CREATE TYPE public.championship_result AS ENUM (
    'win',
    'loss'
);


ALTER TYPE public.championship_result OWNER TO robot;

--
-- Name: attacker_by_id(integer); Type: FUNCTION; Schema: public; Owner: robot
--

CREATE FUNCTION public.attacker_by_id(id integer) RETURNS bigint
    LANGUAGE sql
    AS $$
SELECT atack
FROM weapon
...
ALTER FUNCTION public.attacker_by_id(id integer) OWNER TO robot;

--
-- Name: mighty_player(); Type: FUNCTION; Schema: public; Owner: robot
--

CREATE FUNCTION public.mighty_player() RETURNS bigint
    LANGUAGE sql
    AS $$
SELECT atack
FROM weapon
...
ALTER FUNCTION public.mighty_player() OWNER TO robot;

--
-- Name: update_pilot_trigger(); Type: FUNCTION; Schema: public; Owner: robot
--

CREATE FUNCTION public.update_pilot_trigger() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
...
ALTER FUNCTION public.update_pilot_trigger() OWNER TO robot;
...
CREATE TABLE public.championship_statuses (
    ...
    champ_result public.championship_result
);
...
--
-- Name: pilot_features; Type: VIEW; Schema: public; Owner: robot
--

CREATE VIEW public.pilot_features AS
 SELECT DISTINCT pilot.name_id AS pilot_name,
   ...
   FROM ((((public.pilot
     LEFT JOIN public.users ON ((users.user_id = pilot.id)))
     JOIN public.car ON ((car.id = pilot.id)))
     RIGHT JOIN public.weapon ON ((weapon.id = car.id)))
     JOIN public.championship ON ((pilot.id = championship.id)));


ALTER TABLE public.pilot_features OWNER TO robot;
...
--
-- Name: pilot_table; Type: VIEW; Schema: public; Owner: robot
--

CREATE VIEW public.pilot_table AS
 SELECT championship_statuses.status_name,
    pilot.id,
    pilot.name_id,
    pilot.status_id,
    pilot.cap,
    pilot.garment,
    pilot.face
   FROM (public.championship_statuses
     LEFT JOIN public.pilot ON ((pilot.status_id = championship_statuses.id)));


ALTER TABLE public.pilot_table OWNER TO robot;

--
-- Name: tool; Type: TABLE; Schema: public; Owner: robot
--
...
ALTER TABLE public.tool OWNER TO robot;
...
ALTER SEQUENCE public.tools_id_seq OWNED BY public.tool.id;
...
--
-- Name: wheel; Type: TABLE; Schema: public; Owner: robot
--
...
ALTER TABLE public.wheel OWNER TO robot;
...
ALTER SEQUENCE public.wheels_id_seq OWNED BY public.wheel.id;
...
--
-- Name: tool id; Type: DEFAULT; Schema: public; Owner: robot
--

ALTER TABLE ONLY public.tool ALTER COLUMN id SET DEFAULT nextval('public.tools_id_seq'::regclass);
...
--
-- Name: wheel id; Type: DEFAULT; Schema: public; Owner: robot
--

ALTER TABLE ONLY public.wheel ALTER COLUMN id SET DEFAULT nextval('public.wheels_id_seq'::regclass);
...
COPY public.championship_statuses (id, status_name, status_id, champ_result) FROM stdin;
1	win	2	win
2	loss	1	loss
\.
...
4	Amena	2	50	1	94
5	Gay	2	65	3	98
6	Penelope	1	49	99	100
7	Ivan	2	59	67	54
8	Kevin	2	83	57	8
9	Lunea	1	17	40	1
10	Lenore	1	56	17	23
11	Jordan	2	77	45	10
12	Ginger	2	28	69	73
13	Kim	2	95	71	53
14	Bryar	2	48	39	19
15	Colleen	2	67	80	1
16	Jenette	2	18	76	73
17	Paki	2	44	10	70
18	Isadora	2	19	59	5
19	Kelsey	2	19	1	17
20	Quon	1	46	79	88
21	Alyssa	1	69	97	30
22	Sonya	1	30	71	75
23	Hannah	1	4	4	92
24	Quemby	1	31	44	24
25	Micah	1	62	57	26
26	Stewart	1	6	95	98
27	Oliver	2	32	8	27
28	Herrod	2	91	2	57
29	Benedict	1	2	59	75
30	Grady	1	47	80	56
31	Cruz	2	92	79	4
32	Laith	2	30	58	12
33	Nicholas	1	2	61	10
34	Elizabeth	1	56	23	42
35	Chaim	1	5	85	69
36	Susan	2	64	30	66
37	Haviva	1	24	96	36
38	Keefe	2	11	99	84
39	Iris	2	26	62	54
40	Emmanuel	1	37	35	44
41	Hector	2	98	71	94
42	Harlan	1	91	19	16
43	Halla	2	76	47	96
44	Arthur	2	45	34	76
45	Illana	1	32	6	49
46	Rinah	2	92	93	35
47	Bo	2	2	53	29
48	Samson	2	44	73	96
49	Baxter	1	67	5	39
50	Jolene	2	22	87	8
51	Cameran	2	49	90	98
52	Audra	2	56	69	41
53	Oliver	2	89	51	72
54	Caleb	2	80	27	91
55	Constance	2	50	93	31
56	Zena	1	33	90	37
57	Tashya	1	10	68	77
58	Sasha	1	23	62	84
59	Keith	1	16	98	39
60	Gabriel	1	62	17	47
61	Cheryl	2	64	48	2
62	Fleur	2	76	56	8
63	Tamekah	2	20	19	45
64	Alfonso	2	73	5	14
65	Stone	1	8	68	34
66	Harper	1	17	38	68
67	Mara	2	63	53	50
68	George	1	74	51	63
69	Gisela	1	83	84	86
70	Tucker	2	56	66	92
71	Alisa	2	69	70	30
72	Ella	1	24	89	89
73	Myles	2	17	90	4
74	Whilemina	2	37	21	72
75	Madeline	1	24	0	42
76	Axel	1	68	47	36
77	Hiram	2	40	30	16
78	Belle	1	99	33	38
79	Ivor	1	76	100	32
80	Dustin	2	41	16	47
81	Holmes	2	44	20	42
82	Alana	2	93	24	18
83	Malcolm	1	9	54	86
84	Kermit	1	37	48	43
85	Kirsten	1	68	15	67
86	Ifeoma	2	27	65	39
87	Kelly	1	88	23	18
88	Celeste	1	83	99	71
89	Cara	1	92	55	58
90	Stacy	2	35	62	85
91	Levi	1	94	70	62
92	Holmes	2	12	32	77
93	Sydney	1	35	65	51
94	Jessica	2	89	73	63
95	Madonna	2	46	36	30
96	Buckminster	1	42	43	79
97	Noel	2	38	12	68
98	TaShya	1	99	79	14
99	Ayanna	1	96	46	51
100	Malik	1	5	11	9
\.


--
-- Data for Name: tool; Type: TABLE DATA; Schema: public; Owner: robot
--

COPY public.tool (id, tool_name, energy, health, tool_level) FROM stdin;
1	Lifter	10	93663	3
2	Lifter	5	97706	8
...
33	Abraham	sed.congue.elit@icloud.net	faucibus	1	2022-06-13 01:52:42
...
--
-- Data for Name: wheel; Type: TABLE DATA; Schema: public; Owner: robot
--

COPY public.wheel (id, wheel_name, energy, health, wheel_level) FROM stdin;
...
SELECT pg_catalog.setval('public.championship_statuses_id_seq', 2, true);
...
ALTER TABLE ONLY public.championship_statuses
    ADD CONSTRAINT championship_statuses_pkey PRIMARY KEY (id, status_id);


--
-- Name: championship_statuses championship_statuses_status_id_key; Type: CONSTRAINT; Schema: public; Owner: robot
--

ALTER TABLE ONLY public.championship_statuses
    ADD CONSTRAINT championship_statuses_status_id_key UNIQUE (status_id);


--
-- Name: championship_statuses championship_statuses_status_name_key; Type: CONSTRAINT; Schema: public; Owner: robot
--

ALTER TABLE ONLY public.championship_statuses
    ADD CONSTRAINT championship_statuses_status_name_key UNIQUE (status_name);
...
ALTER TABLE ONLY public.pilot
    ADD CONSTRAINT pilot_pkey PRIMARY KEY (id, status_id);


--
-- Name: tool tools_pkey; Type: CONSTRAINT; Schema: public; Owner: robot
--
...
--
-- Name: wheel wheels_pkey; Type: CONSTRAINT; Schema: public; Owner: robot
--
...
--
-- Name: pilot_name_id_idx; Type: INDEX; Schema: public; Owner: robot
--

CREATE INDEX pilot_name_id_idx ON public.pilot USING btree (name_id);


--
-- Name: users_user_id_idx; Type: INDEX; Schema: public; Owner: robot
--
...
--
-- Name: championship check_before_update_pilot_trigger; Type: TRIGGER; Schema: public; Owner: robot
--

CREATE TRIGGER check_before_update_pilot_trigger BEFORE UPDATE ON public.championship FOR EACH ROW EXECUTE FUNCTION public.update_pilot_trigger();


--
-- Name: users check_before_update_pilot_trigger; Type: TRIGGER; Schema: public; Owner: robot
--

CREATE TRIGGER check_before_update_pilot_trigger BEFORE UPDATE ON public.users FOR EACH ROW EXECUTE FUNCTION public.update_pilot_trigger();
...
ALTER TABLE ONLY public.car
    ADD CONSTRAINT car_tool_id_fk FOREIGN KEY (tool_id) REFERENCES public.tool(id) ON DELETE CASCADE;
...
--
-- Name: car car_wheel_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: robot
--

ALTER TABLE ONLY public.car
    ADD CONSTRAINT car_wheel_id_fk FOREIGN KEY (wheels_id) REFERENCES public.wheel(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.pilot
    ADD CONSTRAINT pilot_status_id_fk FOREIGN KEY (status_id) REFERENCES public.championship_statuses(status_id) ON DELETE CASCADE;
